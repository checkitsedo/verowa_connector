...
#
# Table structure for table 'tx_verowaconnector_domain_model_person'
#
CREATE TABLE tx_verowaconnector_domain_model_person (
...
#
# Table structure for table 'tx_verowaconnector_domain_model_targetgroup'
#
CREATE TABLE tx_verowaconnector_domain_model_targetgroup (
...
#
# Table structure for table 'tx_verowaconnector_domain_model_layer'
#
CREATE TABLE tx_verowaconnector_domain_model_layer (
...
#
# Table structure for table 'tx_verowaconnector_domain_model_event_person_mm'
#
CREATE TABLE tx_verowa_event_person_mm (
...
#
# Table structure for table 'tx_verowaconnector_domain_model_event_targetgroup_mm'
#
CREATE TABLE tx_verowa_event_targetgroup_mm (
    uid_local int(11) unsigned DEFAULT 0 NOT NULL COMMENT 'tx_verowaconnector_domain_model_event.uid',
...
#
# Table structure for table 'tx_verowaconnector_domain_model_event_layer_mm'
#
CREATE TABLE tx_verowa_event_layer_mm (
    uid_local int(11) unsigned DEFAULT 0 NOT NULL COMMENT 'tx_verowaconnector_domain_model_event.uid',
